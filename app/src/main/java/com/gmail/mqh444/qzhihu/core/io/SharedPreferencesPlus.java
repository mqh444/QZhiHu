package com.gmail.mqh444.qzhihu.core.io;
...
import com.gmail.mqh444.qzhihu.BuildConfig;
import com.gmail.mqh444.qzhihu.core.log.XLog;
import com.google.gson.Gson;


/**
 * 帮助存取SharedPreference,支持obj存取, obj是使用gson序列化的
 * 同时提供在保存数据时候，可以保存app版本
...
public class SharedPreferencesPlus {
    ...
    /**
     * 获取保存的对象，由于保存的时候是以json字符串保存，没有保存class类型，
     * 所以如果type与原先保存的对象的类型有冲突，结果返回是null
     *
     * @param key
     * @param type
     * @param <T>
